  ...
  <div class="page-container">
    ...
    <div :class="['page', { shifted: sidebarOpen }]">
      ...
      <div class="top-header">
        ...
        <h1 class="header-title">LIST OF DEPUTIZED FISH WARDEN (2029)</h1>
      </div>
...
// LOAD 2029 DATA FROM FIRESTORE
onMounted(async () => {
  const snap = await getDocs(collection(db, "dfwRecords2029"))
  records.value = snap.docs.map(d => ({ ...d.data(), firebaseId: d.id }))
  console.log("Loaded 2029 records:", records.value)
})
